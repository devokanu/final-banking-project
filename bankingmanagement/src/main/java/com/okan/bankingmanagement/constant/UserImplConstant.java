...
public class UserImplConstant {
	...
	public static final String USERNAME_ALREADY_EXISTS = "Given username already Used: ";
    public static final String EMAIL_ALREADY_EXISTS = "Given email already Used: ";
